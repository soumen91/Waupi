...
public class SchedulePickup extends BaseScreen{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imageloader = new ImageLoader(SchedulePickup.this);
		pref = getSharedPreferences("TUTORIALTRAVERSE",Context.MODE_PRIVATE);
		
		cd = new ConnectionDetector(getApplicationContext());
		if (!cd.isConnectingToInternet()) {
			alert.showAlertDialog(SchedulePickup.this,
...
/*		ll_etashuttle = (LinearLayout)findViewById(R.id.ll_etashuttle);
	...
	@Override
	public void init(){
		//tv_cityName.setText(app.getReservationStatusInfo().hotel_city);
		//tv_phone_num.setText(Constant.HEmIntent = new Intent(Valet.this,Housekeeping.class);
		//startActivity(mIntent);LPDESK_PH_NO);
		if(!app.getTutorialInfo().isAuthenticated()){
			...
			tv_roomno.setText("");
			tv_phone_num.setText(app.getHotelInfo().laundry_pick_up);
			tv_name.setText("Welcome "+app.getUserInfo().fname);
	...
	public void onClick(View v) {
		...
		case R.id.ll_call:
			if (getPackageManager().hasSystemFeature(PackageManager.FEATURE_TELEPHONY)) {
			  ...
			  Toast.makeText(SchedulePickup.this, "You don't have permission to Call in your device", 6000).show();
			}
			break;
		...
		case R.id.ll_etashuttle:
			mIntent = new Intent(SchedulePickup.this,EtaShuttle.class);				
			startActivity(mIntent);
			finish();
			break;
			
		case R.id.ll_checkin:
			mIntent = new Intent(SchedulePickup.this,CheckIn.class);				
			startActivity(mIntent);
			finish();
			break;
			
		/*case R.id.ll_housekeeping:
			mIntent = new Intent(SchedulePickup.this,Housekeeping.class);				
			slidingMenu.toggle();
			break;*/
			
		case R.id.ll_expolreicon:
			mIntent = new Intent(SchedulePickup.this,ExploreHotel.class);				
			startActivity(mIntent);
			finish();
			break;
			
		case R.id.ll_connect:
			mIntent = new Intent(SchedulePickup.this,Connect.class);				
			startActivity(mIntent);
			finish();
			break;
			
		case R.id.ll_feedback:
			mIntent = new Intent(SchedulePickup.this,Feedback.class);				
			startActivity(mIntent);
			break;
	...
	private void gotoLoginScreen() {
		runOnUiThread(new Runnable() {
			@Override
			public void run() {
				Intent i = new Intent(SchedulePickup.this,DashBorad.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
	...
	protected void onResume() {
		...
		if(pref.getBoolean("DUMMY_ACCESS", false)){
			...
			edit.commit();
			Intent i = new Intent(SchedulePickup.this, SchedulePickup.class);
			startActivity(i);
