...
public class SelectedHotelListAdapter extends ArrayAdapter<SelectedHotelListBean>{
	private ArrayList<SelectedHotelListBean> mMerchant = new ArrayList<SelectedHotelListBean>();
	private ViewHolder mHolder;
	private Activity activity;
	public ImageLoader imageLoader;

	public SelectedHotelListAdapter(Activity activity, int textViewResourceId,ArrayList<SelectedHotelListBean> items) {
	...
	public View getView( final int position,  View convertView, ViewGroup parent) {
		...
		final SelectedHotelListBean mVendor = mMerchant.get(position);
